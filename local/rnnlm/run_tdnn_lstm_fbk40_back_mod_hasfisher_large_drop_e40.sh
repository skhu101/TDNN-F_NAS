...
dir=exp/rnnlm_lstm_1e_backward_large_drop_e40
embedding_dim=1024
affine_dim=2048
cell_dim=2048
lstm_rpd=512
...
#ac_model_dir=exp_kaldi_feats/chain/cnn_tdnn_iv_1a_hires_sp
...
text_dir=data/rnnlm/text_nosp_1e_back_large_drop_e40
mkdir -p $dir/config
set -e
...
if [ $stage -le 4 ] && $run_lat_rescore; then
  ...
  for decode_set in rt03_fbk_40; do
    ...
    echo ${decode_dir}_${decode_dir_suffix_forward}_0.45
    ...
    rnnlm/lmrescore_back.sh \
      ...
      data/lang_$LM $dir \
      data/${decode_set} ${decode_dir}_${decode_dir_suffix_forward}_0.45 \
