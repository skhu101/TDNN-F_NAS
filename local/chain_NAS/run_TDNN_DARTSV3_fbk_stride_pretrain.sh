...
dir=exp/chain_NAS/tdnn_DARTSV3_context_offset${offset_len}_95peronehotpretrain${affix}${suffix}
common_egs_dir=
...
train_set=train_fbk_40_nodev_nodup_for_nas$suffix
...
if [ $stage -le 12 ]; then
  ...
  tdnnf_opts="l2-regularize=0.01 dropout-proportion=0.0 bypass-scale=0.66 use-gumbel=false use-entropy=false free-select=false update-alpha=false update-theta=true uniform-sample=true"
  ...
  tdnnfdartsv3-layer name=tdnnf2 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf3 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf4 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf5 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf6 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf7 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf8 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf9 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf10 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf11 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf12 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf13 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf14 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnfdartsv3-layer name=tdnnf15 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
...
EOF
  ...
  ~/anaconda3/bin/python local/chain_NAS/scripts/generate_config.py ${offset_len} $dir/configs/
...
#    --cmd "queue.pl --config /home/dpovey/queue_conly.conf" \
  ...
  steps/nnet3/chain/train.py --stage $train_stage \
    --cmd "$train_cmd" \
    --feat.online-ivector-dir exp/nnet3/ivectors_train_nodev_nodup_for_nas$suffix \
    ...
    --tree-dir $treedir \
    --lat-dir exp/tri4_lats_nodev_nodup_for_nas$suffix \
    --dir $dir  || exit 1;
