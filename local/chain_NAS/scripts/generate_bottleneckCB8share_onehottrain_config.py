    ...
    with open(config_path+'/final_ori.config') as f:
        for line in f.readlines():
            ...
            if 'component name=tdnnf'+str(count)+'.linear' in line:
                ...
                if count == 2:
                    out_f.write("component name="+tdnnf_name+".linear type=TdnnComponent input-dim=1536 output-dim=240 l2-regularize=0.01 max-change=0.75 use-bias=false time-offsets=-1,0 orthonormal-constraint=-1.0"+"\n")
                    ...
                    out_f.write("component name="+tdnnf_name+".linear type=TdnnComponent input-dim=1536 output-dim=240 l2-regularize=0.01 max-change=0.75 use-bias=false time-offsets=-3,0 orthonormal-constraint=-1.0"+"\n")
                    out_f.write("component-node name="+tdnnf_name+".linear component="+tdnnf_name+".linear input="+tdnnfpre_name+".noop"+"\n")
                ...
                if count <= 4:
                    out_f.write("component name="+tdnnf_name+".affine type=TdnnComponent input-dim=240 output-dim=1536 l2-regularize=0.01 max-change=0.75 time-offsets=0,1"+"\n")
                    ...
                    out_f.write("component name="+tdnnf_name+".affine type=TdnnComponent input-dim=240 output-dim=1536 l2-regularize=0.01 max-change=0.75 time-offsets=0,3"+"\n")
                    out_f.write("component-node name="+tdnnf_name+".affine component="+tdnnf_name+".affine input=Append("+tdnnf_name+"0.output,"+tdnnf_name+"1.output,"+tdnnf_name+"2.output,"+tdnnf_name+"3.output,"+tdnnf_name+"4.output,"+tdnnf_name+"5.output,"+tdnnf_name+"6.output,"+tdnnf_name+"7.output)"+"\n")
