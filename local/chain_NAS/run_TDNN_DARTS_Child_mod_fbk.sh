...
#cd /project_bdda3/bdda/skhu/toolkits/kaldi/egs/swbd/s5c
...
if [[ $parent_path =~ "95onehotpretrain_cvupdate_gumbel" ]]; then
    dir=exp/chain_NAS/tdnn_DARTS_context_offset${offset}_95onehotpretrain_cvupdate_gumbel_Child_Top${top_id}${affix}${suffix}
elif [[ $parent_path =~ "95onehotpretrain_cvupdate_softmax" ]]; then
    dir=exp/chain_NAS/tdnn_DARTS_context_offset${offset}_95onehotpretrain_cvupdate_softmax_Child_Top${top_id}${affix}${suffix}
elif [[ $parent_path =~ "gumbel" ]]; then
    dir=exp/chain_NAS/tdnn_DARTS_context_offset${offset}_gumbel_Child_Top${top_id}${affix}${suffix}
elif [[ $parent_path =~ "softmax" ]]; then
    dir=exp/chain_NAS/tdnn_DARTS_context_offset${offset}_softmax_Child_Top${top_id}${affix}${suffix}
fi
...
#train_set=train_fbk_nodup$suffix
#treedir=exp/chain/tri5_7d_tree$suffix
...
if [ $stage -le 12 ]; then
  ...
  tdnnf-layer name=tdnnf2 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf3 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf4 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf5 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf6 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf7 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf8 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf9 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf10 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf11 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf12 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf13 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf14 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
  tdnnf-layer name=tdnnf15 $tdnnf_opts dim=1536 bottleneck-dim=160 time-stride=6
...
EOF
  ...
  ~/anaconda3/bin/python local/chain_NAS/scripts/generate_top_list.py $parent_path $child_type $top_id $dir/configs/ $offset "tdnn"
...
#
#    steps/lmrescore_const_arpa.sh --cmd "$decode_cmd" \
#      data/lang_sw1_{tg,fg_htk_arpa} data/${decode_set} \
...
rm -rf $dir/egs
# > $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_tg/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_tg/score_*/*.ctm.callhm.filt.sys | utils/best_wer.sh >> $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_tg/score_*/*.ctm.filt.sys | utils/best_wer.sh >> $dir/scoring_all

# grep Sum $dir/decode_eval2000_fbk_sw1_fg_arpa/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_fg_arpa/score_*/*.ctm.callhm.filt.sys | utils/best_wer.sh >> $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_fg_arpa/score_*/*.ctm.filt.sys | utils/best_wer.sh >> $dir/scoring_all

# grep Sum $dir/decode_eval2000_fbk_sw1_tg_htk_arpa/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_tg_htk_arpa/score_*/*.ctm.callhm.filt.sys | utils/best_wer.sh >> $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_tg_htk_arpa/score_*/*.ctm.filt.sys | utils/best_wer.sh >> $dir/scoring_all

# grep Sum $dir/decode_eval2000_fbk_sw1_fg_htk_arpa/score_*/*.ctm.swbd.filt.sys | utils/best_wer.sh >> $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_fg_htk_arpa/score_*/*.ctm.callhm.filt.sys | utils/best_wer.sh >> $dir/scoring_all
# grep Sum $dir/decode_eval2000_fbk_sw1_fg_htk_arpa/score_*/*.ctm.filt.sys | utils/best_wer.sh >> $dir/scoring_all
