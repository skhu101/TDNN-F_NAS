...
dir=exp/chain_NAS/tdnn_DARTS_${offset_type}_bottleneckCBshare_95onehotpretrain_cvupdate_softmax_flopsconstraint_${flops_coef}

if [ "$use_gumbel" = true ] ; then
    dir=exp/chain_NAS/tdnn_DARTS_${offset_type}_bottleneckCBshare_95onehotpretrain_cvupdate_gumbel_flopsconstraint_${flops_coef}
fi
