...
dir=exp/chain_NAS/tdnn_DARTS_bottleneckCBshare_95onehottrain_25_50_80_100_120_160_200_240${affix}${suffix}
common_egs_dir=
...
EOF
  ...
  python local/chain_NAS/scripts/generate_bottleneckCB8share_onehottrain_config.py $dir/configs
fi
