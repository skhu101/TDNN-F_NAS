...
ComponentPrecomputedIndexes* ComponentPrecomputedIndexes::NewComponentPrecomputedIndexesOfType(
  ...
  } else if (cpi_type == "TimeHeightConvolutionDARTSComponentPrecomputedIndexes") {
    ans = new TimeHeightConvolutionDARTSComponent::PrecomputedIndexes();
  } else if (cpi_type == "TimeHeightConvolutionDARTSTimeComponentPrecomputedIndexes") {
    ans = new TimeHeightConvolutionDARTSTimeComponent::PrecomputedIndexes();
  } else if (cpi_type == "TimeHeightConvolutionDARTSTimeComponentPrecomputedIndexes") {
    ans = new TimeHeightConvolutionDARTSTimeComponent::PrecomputedIndexes();
  } else if (cpi_type == "BayesTimeHeightConvolutionComponentPrecomputedIndexes") {
    ans = new BayesTimeHeightConvolutionComponent::PrecomputedIndexes();
  ...
  } else if (cpi_type == "TdnnSelectComponentPrecomputedIndexes") {
    ans = new TdnnSelectComponent::PrecomputedIndexes();
  } else if (cpi_type == "TdnnDARTSComponentPrecomputedIndexes") {
    ans = new TdnnDARTSComponent::PrecomputedIndexes();
  } else if (cpi_type == "TdnnDARTSV2ComponentPrecomputedIndexes") {
    ans = new TdnnDARTSV2Component::PrecomputedIndexes();
  } else if (cpi_type == "TdnnDARTSV3ComponentPrecomputedIndexes") {
    ans = new TdnnDARTSV3Component::PrecomputedIndexes();
  } else if (cpi_type == "TdnnDARTSV3SelectComponentPrecomputedIndexes") {
    ans = new TdnnDARTSV3SelectComponent::PrecomputedIndexes();
  } else if (cpi_type == "BayesTdnnComponentPrecomputedIndexes") {
    ans = new BayesTdnnComponent::PrecomputedIndexes();
  } else if (cpi_type == "BayesTdnnV2ComponentPrecomputedIndexes") {
    ans = new BayesTdnnV2Component::PrecomputedIndexes();
  } else if (cpi_type == "VTdnnComponentPrecomputedIndexes") {
    ans = new VTdnnComponent::PrecomputedIndexes();
  }
  if (ans != NULL) {
...
Component* Component::NewComponentOfType(const std::string &component_type) {
  ...
  } else if (component_type == "TdnnSelectComponent") {
    ans = new TdnnSelectComponent();
  ...
  } else if (component_type == "TimeHeightConvolutionDARTSComponent") {
    ans = new TimeHeightConvolutionDARTSComponent();
  } else if (component_type == "TimeHeightConvolutionDARTSTimeComponent") {
    ans = new TimeHeightConvolutionDARTSTimeComponent();
  } else if (component_type == "BayesTimeHeightConvolutionComponent") {
    ans = new BayesTimeHeightConvolutionComponent();
  ...
  } else if (component_type == "NormalRandComponent") { ///////////////////
  ...
  } else if (component_type == "GPActivationComponent") { ///////////////////
    ans = new GPActivationComponent();
  } else if (component_type == "NaturalGradientGPActivationComponent") { ///////////////////
    ans = new NaturalGradientGPActivationComponent();
  } else if (component_type == "TdnnDARTSComponent") {
    ans = new TdnnDARTSComponent();
  } else if (component_type == "TdnnDARTSV2Component") {
    ans = new TdnnDARTSV2Component();
  } else if (component_type == "TdnnDARTSV3Component") {
    ans = new TdnnDARTSV3Component();
  } else if (component_type == "TdnnDARTSV3SelectComponent") {
    ans = new TdnnDARTSV3SelectComponent();
  } else if (component_type == "BayesTdnnComponent") {
    ans = new BayesTdnnComponent();
  } else if (component_type == "BayesTdnnV2Component") {
    ans = new BayesTdnnV2Component();
  } else if (component_type == "VTdnnComponent") {
    ans = new VTdnnComponent();
  } else if (component_type == "FlopsConstraintComponent") {
    ans = new FlopsConstraintComponent();
  } else if (component_type == "OnehotFunctionComponent") {
    ans = new OnehotFunctionComponent();
  } else if (component_type == "SoftmaxgradnormComponent") {
    ans = new SoftmaxgradnormComponent();
  } else if (component_type == "GumbelSoftmaxComponent") {
    ans = new GumbelSoftmaxComponent();
  } else if (component_type == "ArgmaxOnehotFunctionComponent") {
    ans = new ArgmaxOnehotFunctionComponent();
