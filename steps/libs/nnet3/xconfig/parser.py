...
config_to_layer = {
        ...
        'convdarts-relu-batchnorm-layer': xlayers.XconfigConvDARTSLayer,
        'convdartstime-relu-batchnorm-layer': xlayers.XconfigConvDARTSTimeLayer,
        ...
        'tdnnfdarts-layer': xlayers.XconfigTdnnfDARTSLayer,
        'tdnnfdartsv2-layer': xlayers.XconfigTdnnfDARTSV2Layer,
        'tdnnfdartsv3-layer': xlayers.XconfigTdnnfDARTSV3Layer,
        'bayestdnnf-layer': xlayers.XconfigBayesTdnnfLayer,
        'gptdnnf-layer': xlayers.XconfigGPTdnnfLayer,
}
