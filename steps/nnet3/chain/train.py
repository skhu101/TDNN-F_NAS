...
def get_args():
    ...
    # Temptecture schedule in GumbelSoftmax
    parser.add_argument("--temperature_schedule", action='store_true', default=False,
                        help="Temperature used in GumbelSoftmax")
        ...
        if args.stage <= iter:
            ...
            chain_lib.train_one_iteration(
                ...
                dropout_edit_string=common_train_lib.get_dropout_edit_string(
                    ...
                    iter) if not args.temperature_schedule else common_train_lib.get_dropout_edit_string(
                    args.dropout_schedule,
                    float(num_archives_processed) / num_archives_to_process,
                    iter) + common_train_lib.get_temperature_edit_string(
                    float(num_archives_processed) / num_archives_to_process,
                    iter),               
